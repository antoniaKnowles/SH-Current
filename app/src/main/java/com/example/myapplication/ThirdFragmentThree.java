...
public class ThirdFragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_third_three, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.button_third).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MainActivity.addQuestionNumber();
                NavHostFragment.findNavController(ThirdFragmentThree.this)
                        .navigate(R.id.action_thirdFragmentThird_to_secondFragmentThree);//changing line that directs too the 3nd question fragment
            }
        });
    }
